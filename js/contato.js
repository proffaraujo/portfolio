...
const btnFecharModal = document.getElementById("btn-fechar-modal"); // id definido no HTML
...
function marcarInvalido(campo) {
  ...
  campo.setAttribute("aria-invalid", "true"); // leitores de tela precisam disso
}

// volta ao normal — tira o vermelho, bota borda verde, esconde o erro
...
function validarFormulario() {
  ...
  // nome: mínimo 3 chars — "Jo" não conta
  ...
  // mensagem: mínimo 10 chars — evita envios de "oi" e ponto final
...
// e já limpa o erro visual quando ele começa a corrigir (input)
